- [Class methods and properties](#class-methods-and-properties)
- [var_dump is your friend](#var_dump-is-your-friend)
- [Getters and setters](#getters-and-setters)
  - [Create setter method](#create-setter-method)
- [Encapsulation](#encapsulation)
  - [private](#private)
  - [Class Validation example](#class-validation-example)
- [Inheritance](#inheritance)
  - [Another example](#another-example)
  - [We look at encapsulation: private](#we-look-at-encapsulation-private)
- [Class Files](#class-files)
  - [Directory structure](#directory-structure)
- [Autoloading PSR4 and Composer](#autoloading-psr4-and-composer)
  - [Composer](#composer)
- [Interfaces](#interfaces)
- [Abstract methods](#abstract-methods)
  - [How Abstract classes can be similar to interfeces](#how-abstract-classes-can-be-similar-to-interfeces)
- [Typehinting](#typehinting)
  - [Using Typehinting](#using-typehinting)
  - [Shopping cart example](#shopping-cart-example)
  - [Type Hinting by model name function add(Item $item)](#type-hinting-by-model-name-function-additem-item)
  - [type hinting interfaces](#type-hinting-interfaces)
- [Static properties and methods](#static-properties-and-methods)
  - [Static Property](#static-property)
  - [Validation example using static](#validation-example-using-static)
  - [Static method vs Facades in Laravel](#static-method-vs-facades-in-laravel)
- [Traits](#traits)
  - [Using Trait real life example](#using-trait-real-life-example)
  - [How Laravel use traits](#how-laravel-use-traits)
  - [In our last example we use traits within traits](#in-our-last-example-we-use-traits-within-traits)
- [Exceptions](#exceptions)
  - [try and catch](#try-and-catch)
  - [Custom Exception](#custom-exception)
  - [Using the finally part of try and catch](#using-the-finally-part-of-try-and-catch)
- [Dependency Injection](#dependency-injection)
  - [Magic Methods](#magic-methods)
  - [Concept of depency injection](#concept-of-depency-injection)
- [Method Chaining](#method-chaining)
- [Autoloading and structure](#autoloading-and-structure)
